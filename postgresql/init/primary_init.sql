...
SELECT * FROM pg_create_logical_replication_slot('my_subscription_slot', 'pgoutput');
-- SELECT * FROM pg_create_logical_replication_slot('my_subscription_slot2', 'pgoutput');
